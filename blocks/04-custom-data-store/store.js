...
const actions = {
  ...
  *persistSetting() {
    ...
    const newSetting = yield controlActions.saveToAPI(path, existingSetting);
    return controlActions.setSetting(newSetting);
  }
};
...
registerStore("my-shop", {
  ...
  resolvers: {
    *getSetting() {
      const path = "/jsforwpadvgb/v1/block-setting";
      const setting = yield controlActions.fetchFromAPI(path);
