...
// 	load_plugin_textdomain( 'jsforwpadvblocks', false, dirname( plugin_basename( __DIR__ ) ) . '/languages/' );
// }
...
// 		'wp.i18n.setLocaleData( ' . json_encode( wp_get_jed_locale_data( 'jsforwpadvblocks' ) ) . ', "jsforwpadvblocks" );',
// 		'before'
// 	);
// }